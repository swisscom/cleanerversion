...
#
# The following code makes Django model Fields appear in the documentation.
# (Django hides these away in _meta.fields)
...
# Workaround to allow documentation of djorm_pgarray fields
from django.db.models.fields.subclassing import Creator
Creator.__get__ = lambda self, *args, **kwargs: self

# Workaround to allow documentation of JSONField model fields:
from jsonfield.subclassing import Creator as JsonCreator
JsonCreator.__get__ = lambda self, *args, **kwargs: self
